...
const GRUPPEN: { titel: string; punkte: Punkt[] }[] = [
  {
    ...
    punkte: [
      ...
      { icon: 'streak', titel: 'Saison-Rahmen', text: 'Selbst erlesen, mit PRO zusätzlich in Gold – ohne Zufallsboxen', da: true },
      { icon: 'mastery', titel: 'Animierter Stein', text: 'Ein Lichtschein wandert über den aktiven Tab', da: true },
