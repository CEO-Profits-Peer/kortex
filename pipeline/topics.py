...
_RAW: list[tuple[str, str, str]] = [
    ...
    ("history.modern", "de", "Industrielle Revolution"),
    ("history.modern", "de", "Berliner Mauer"),
    ("history.modern", "en", "Industrial Revolution"),
    ("history.modern", "en", "Cold War"),
    ("history.modern", "en", "Silk Road"),
    ("language.languages", "de", "Sprachfamilie"),
    ("language.languages", "en", "Language family"),
    ("language.languages", "en", "Lingua franca"),
    ("language.languages", "en", "Writing system"),
    ("language.media", "de", "Pressefreiheit"),
    ("language.media", "de", "Filterblase"),
    ("language.media", "en", "Freedom of the press"),
    ("language.media", "en", "Misinformation"),
    ("language.media", "en", "Filter bubble"),
    ...
    # --- Welt ----------------------------------------------------
    ("culture.art", "de", "UNESCO-Welterbe"),
    ("culture.art", "en", "World Heritage Site"),
    ("history.modern", "de", "Kalter Krieg"),
    ("language.media", "de", "Desinformation"),
    # --- Neue Hauptthemen (Migration 0082) ------------------------------
    # Je Unterthema mindestens zwei Lemmata pro Sprache: die Entdeckung
    # (topic_discovery.py) braucht zwei Ausgangsthemen derselben Kategorie,
    # sonst ist ein Verweis Zufall statt Muster.
    ("history.early", "de", "Römisches Reich"),
    ("history.early", "de", "Mittelalter"),
    ("history.early", "de", "Buchdruck"),
    ("history.early", "de", "Schwarzer Tod"),
    ("history.early", "en", "Roman Empire"),
    ("history.early", "en", "Middle Ages"),
    ("history.early", "en", "Printing press"),
    ("history.early", "en", "Black Death"),
    ("history.modern", "de", "Französische Revolution"),
    ("history.modern", "de", "Erster Weltkrieg"),
    ("history.modern", "de", "Kolonialismus"),
    ("history.modern", "en", "French Revolution"),
    ("history.modern", "en", "World War I"),
    ("history.modern", "en", "Colonialism"),
    ("history.democracy", "de", "Gewaltenteilung"),
    ("history.democracy", "de", "Grundrechte"),
    ("history.democracy", "de", "Wahlrecht"),
    ("history.democracy", "de", "Bundes-Verfassungsgesetz"),
    ("history.democracy", "en", "Separation of powers"),
    ("history.democracy", "en", "Parliamentary system"),
    ("history.democracy", "en", "Canadian Charter of Rights and Freedoms"),
    ("history.society", "de", "Menschenrechte"),
    ("history.society", "de", "Frauenwahlrecht"),
    ("history.society", "de", "Generationenvertrag"),
    ("history.society", "en", "Human rights"),
    ("history.society", "en", "Civil rights movement"),
    ("history.society", "en", "Social mobility"),
    ("culture.music", "de", "Tonleiter"),
    ("culture.music", "de", "Hip-Hop"),
    ("culture.music", "de", "Wiener Klassik"),
    ("culture.music", "en", "Scale (music)"),
    ("culture.music", "en", "Hip-hop"),
    ("culture.music", "en", "Rhythm"),
    ("culture.film", "de", "Drehbuch"),
    ("culture.film", "de", "Animationsfilm"),
    ("culture.film", "de", "Filmmusik"),
    ("culture.film", "en", "Screenplay"),
    ("culture.film", "en", "Animation"),
    ("culture.film", "en", "Film score"),
    ("culture.literature", "de", "Roman"),
    ("culture.literature", "de", "Metapher"),
    ("culture.literature", "de", "Märchen"),
    ("culture.literature", "en", "Novel"),
    ("culture.literature", "en", "Metaphor"),
    ("culture.literature", "en", "Poetry"),
    ("culture.art", "de", "Impressionismus"),
    ("culture.art", "de", "Gotik"),
    ("culture.art", "de", "Bauhaus"),
    ("culture.art", "en", "Impressionism"),
    ("culture.art", "en", "Gothic architecture"),
    ("language.words", "de", "Etymologie"),
    ("language.words", "de", "Lehnwort"),
    ("language.words", "de", "Anglizismus"),
    ("language.words", "en", "Etymology"),
    ("language.words", "en", "Loanword"),
    ("language.words", "en", "Slang"),
    ("language.rhetoric", "de", "Rhetorik"),
    ("language.rhetoric", "de", "Argumentation"),
    ("language.rhetoric", "de", "Körpersprache"),
    ("language.rhetoric", "en", "Rhetoric"),
    ("language.rhetoric", "en", "Persuasion"),
    ("language.rhetoric", "en", "Body language"),
    ("language.media", "de", "Fake News"),
    ("language.media", "de", "Clickbait"),
    ("language.media", "en", "Fake news"),
    ("language.media", "en", "Clickbait"),
    ("language.languages", "de", "Indogermanische Sprachen"),
    ("language.languages", "de", "Gebärdensprache"),
    ("language.languages", "de", "Mehrsprachigkeit"),
    ("language.languages", "en", "Sign language"),
]
